...
DATASETS = {
    ...
    'phone_train': {
        IM_DIR:
            _DATA_DIR + '/phone/images/train',
        ANN_FN:
            _DATA_DIR + '/phone/annotations/instances_phone_train.json',
    },
    'phone_val': {
        IM_DIR:
            _DATA_DIR + '/phone/images/val',
        ANN_FN:
            _DATA_DIR + '/phone/annotations/instances_phone_val.json',
    },
    'phone_test': {
        IM_DIR:
            _DATA_DIR + '/phone/images/test',
        ANN_FN:
            _DATA_DIR + '/phone/annotations/instances_phone_test.json',
    },
    'crowdAI_train': {
        IM_DIR:
            _DATA_DIR + '/crowdAI/images/train',
        ANN_FN:
            _DATA_DIR + '/crowdAI/annotations/train_annotation-small.json',
    },
    'crowdAI_val': {
        IM_DIR:
             _DATA_DIR + '/crowdAI/images/val',
        ANN_FN:
             _DATA_DIR + '/crowdAI/annotations/val_annotation-small.json',
    },
    'coco_stuff_train': {
        IM_DIR:
            _DATA_DIR + '/coco/images/train2014',
