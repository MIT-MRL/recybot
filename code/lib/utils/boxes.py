...
def bbox_transform(boxes, deltas, weights=(1.0, 1.0, 1.0, 1.0)):
    ...
    # print(dx.shape, widths[:, np.newaxis].shape)
    # print(widths[:, np.newaxis].max(), dx.max())
    # print(weights)
...
def bbox_transform_inv(boxes, gt_boxes, weights=(1.0, 1.0, 1.0, 1.0)):
    ...
    # print('ex_widths', ex_widths.shape, 'ex_heights', ex_heights.shape)
    # print('test_wid', np.where(ex_widths==0), 'test_hei', np.where(ex_heights==0))
